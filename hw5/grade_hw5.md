...
- XGBoost and random forest can provide variable importance measures. `-5.0`

Performance (45/50): Score will be mainly determined by the distribution of the reported best AUCs in the class.

- The AUC for the stacked model should be slightly greater or equal to the best AUC of the three models. I wonder if the truth was (`1 - 0.370 = 0.630`) by `contains(".pred_TRUE")`. `-5.0`
