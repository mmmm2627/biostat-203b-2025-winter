...
The runtime of compressed file is 1 min 38 secs, compared to uncompressed file of 5 min 17 secs.

The tradeoff is between balancing storage space and run time.

Compressed files are much smaller than the uncompressed counterparts, significantly reducing storage requirement.
This is useful for archiving and transporting large datasets. 
However, operating on compressed files is slower because the file must be decompressed first.
